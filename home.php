 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Your Pets Deserve The Best</h1><br>
           <p class="lead fw-normal text-white-50 mb-0"><h5><b>Looking for your pets and pet needs? Shop Now!</b></h5></p> 
        </div>
    </div>
</header>
<!-- Section-->
