...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><b><?php echo isset($id) ? "Update ": "Create New " ?> Sub Category</b></h3>
	</div>
	<div class="card-body">
		<form action="" id="category-form">
            ...
            <div class="form-group">
                ...
                <select name="parent_id" id="parent_id" class="custom-select select1">
                <option value=""></option>
                <?php
			...
			<div class="form-group">
                ...
                <textarea name="sub_category" id="sub_category" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($sub_category) ? $sub_category : ''; ?></textarea>
			</div>
            <div class="form-group">
