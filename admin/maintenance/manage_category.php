...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><b><?php echo isset($id) ? "Update ": "Create New " ?> Category</b></h3>
	</div>
	<div class="card-body">
		<form action="" id="category-form">
			...
			<div class="form-group">
                ...
                <textarea name="category" id="category" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($category) ? $category : ''; ?></textarea>
			</div>
            <div class="form-group">
