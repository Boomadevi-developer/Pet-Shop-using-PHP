...
.brand-link bg-primary text-sm:hover{
color:white;
background-color:dark;
} 
 </style>
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-gray-primary elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-white text-dark ">
                   ...
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false" >
                    <li class="nav-item dropdown">
                      <a href="./" class="nav-link nav-home">
                        ...
                        <p style="font-size:21px; color:white; font-weight:bold;">
                          Dashboard
                        </p>
                      </a>
                    </li><br>
