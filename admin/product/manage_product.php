...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><b><?php echo isset($id) ? "Update ": "Create New " ?> Pet or Product</b></h3>
	</div>
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
                ...
                <select name="category_id" id="category_id" class="custom-select select1" required>
                <option value=""></option>
                <?php
			...
			<div class="form-group">
				<label for="product_name" class="control-label">Pet/Product Name</label>
                <textarea name="product_name" id="product_name" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($product_name) ? $product_name : ''; ?></textarea>
			</div>
            <div class="form-group">
